...
We have seen that neither of the two HSQC-COSY implementations above (CLIP or DSE) could successfully preserve unused magnetisation.
The triple spin echo (TSE) HSQC-COSY, shown in \cref{fig:hsqcc_tse_po}, was developed as an alternative HSQC-COSY sequence which could.
In terms of the pulse sequence itself, 
